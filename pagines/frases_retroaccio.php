...
class fct_form_frases_retroaccio extends fct_form_base {
    ...
    function configurar($pagina) {
        ...
        $this->element('areatext_linies', 'frases_centre', 'tutor_centre',
                       array('cols' => 60, 'rows' => 15));
        $this->element('areatext_linies', 'frases_empresa', 'tutor_empresa',
                       array('cols' => 60, 'rows' => 15));
...
class fct_pagina_frases_retroaccio extends fct_pagina_base {
    ...
    function mostrar() {
        ...
        $this->form->valor('frases_centre', $this->fct->frases_centre);
        $this->form->valor('frases_empresa', $this->fct->frases_empresa);
